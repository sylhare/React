...
/**
 * Example component that uses organized translation objects
 * from TranslatedText.tsx (COMMON, MESSAGES, CTA, ACTIONS)
 */
...
export function SocialMediaCard({
  ...
  return (
    <div className="rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-md">
      {/* Header */}
