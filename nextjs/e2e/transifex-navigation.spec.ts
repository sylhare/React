...
test.describe('Transifex Examples Navigation', () => {
  test('should navigate to Basic Example', async ({ page }) => {
    ...
    await expect(page.getByTestId('page-heading')).toContainText('Transifex Example');
  });
  ...
  test('should navigate to Reusable Components', async ({ page }) => {
    ...
    await expect(page.getByTestId('page-heading')).toContainText('Reusable Components');
  });
  ...
  test('should navigate to Context & Comments', async ({ page }) => {
    ...
    await expect(page.getByTestId('page-heading')).toContainText('Context & Comments');
  });
  ...
  test('should navigate to String Props', async ({ page }) => {
    ...
    await expect(page.getByTestId('page-heading')).toContainText('String Props Example');
  });
  ...
  test('should navigate to Test _key Attribute', async ({ page }) => {
    ...
    await expect(page.getByTestId('page-heading')).toContainText('Translation Key Attribute Behavior');
  });
